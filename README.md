...
> **[2026-06-27] 인프라 일시 중단**
> 현재 AWS 인프라(EKS, Aurora, VPC 등)를 전체 종료한 상태입니다.
> S3 버킷(파일/템플릿)과 tfstate 백엔드는 보존 중입니다.
> 재가동이 필요하면 `infrastructure/environments/dev` 또는 `prod`에서 `terraform apply`로 복구할 수 있습니다.
